  ...
  <div class="toolbar">
    ...
    >
      ...
      <el-table-column
        ...
        sortable="custom"
      ></el-table-column>
      <el-table-column label="状态明细" :formatter="empty" width="100">
       ...
       <el-table-column label="开发明细" :formatter="empty" width="100">
        <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    exportExcelMxKf() {
      ...
      const data = this.viewFormKf.map(v => filterVal.map(k => v[k]));
