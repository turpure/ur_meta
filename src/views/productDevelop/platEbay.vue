    ...
    >
      <el-row>
        <el-row>
          <el-col :span="24">
            <el-col :span="12">
              <el-col :span="2" class="textZt">SKU</el-col>
              <el-col :span="21">
                <el-input v-model="wishForm.sku"></el-input>
              </el-col>
              <el-col :span="2" class="textZt" style="margin-top: 15px">是否备货</el-col>
              <el-col :span="21" style="margin-top: 15px">
                <el-input v-model="wishForm.stockUp" :disabled="true"></el-input>
              </el-col>
              <el-col :span="2" class="textZt" style="margin-top: 15px">主图</el-col>
              <el-col :span="21" style="margin-top: 15px">
                <el-input v-model="wishForm.mainPage"></el-input>
              </el-col>
              <el-col :span="2" class="textZt" style="margin-top: 15px"></el-col>
            </el-col>
            <el-col :span="10" style="margin-left: 25px">
              <a
                :href="wishForm.mainPage"
                target="_blank"
                style="display: block; width: 155px;height: 155px"
              >
                <img :src="wishForm.mainPage" style="display: block; width: 155px;height: 155px">
              </a>
            </el-col>
          </el-col>
        </el-row>
        ...
        <el-row style="margin-left: 15px">
          ...
          >
            <el-col :span="19">
              <el-col :span="24">
                <el-input v-model="wishForm.extraPage[index]" @input="revise($event,index)"></el-input>
              </el-col>
              <el-col>
        ...
        <el-col :span="6" style="margin-top: 20px;padding-left: 20px">
          <h3 class="spsz">国家</h3>
          <el-input size="small" style="width:245px; margin-top: 4px" v-model="wishForm.country"></el-input>
        </el-col>
        <el-col :span="6" style="margin-top: 20px">
          <h3 class="spsz">商品所在地</h3>
          <el-input size="small" style="width:245px; margin-top: 4px" v-model="wishForm.location"></el-input>
        </el-col>
        <el-col :span="6" style="margin-top: 20px">
          <h3 class="spsz">邮编</h3>
          <el-input size="small" style="width:245px; margin-top: 4px" v-model="wishForm.postCode"></el-input>
        </el-col>
        <el-col :span="6" style="margin-top: 20px">
          <h3 class="spsz">备货天数</h3>
          <el-input size="small" style="width:245px; margin-top: 4px" v-model="wishForm.prepareDay"></el-input>
        </el-col>
      </el-row>
      <el-col :span="24" style="padding: 0">
        ...
        <el-col :span="24">
          ...
          <el-row v-if='showattribute1'>
            <el-col :span="24">
              ...
              <el-col :span="6" style="text-align: right">
                <!-- 第1-12条共12条数据 -->
                <el-button @click="innerVisible = true" type="text" style="margin-right:8px">+增加属性</el-button>
              </el-col>
            </el-col>
          </el-row>
          <el-row v-if='showattribute1'>
            <el-col :span="24">
              ...
              >
                ...
                <tbody>
                  <tr v-for="(item, index) in tabDate" :key="index" style="text-align:center;">
                    <td>{{index+1}}</td>
                    <!-- <td>
                                    <el-checkbox></el-checkbox>
                    </td>-->
                    <td>
                      <i class="el-icon-delete" @click="delIndex(index,item.id)"></i>
                    </td>
                    <td>
              ...
              >
                ...
                <tbody>
                  <tr v-for="(log, index) in title" :key="index" style="text-align:center;">
                    <td v-for="(item, index) in log.value" :key="index" style="line-height: 53px">
          ...
          <el-row style="margin-top: 1px" v-if='showattribute1'>
            ...
            <el-col :span="24" style="margin-top: 15px;margin-bottom: 15px">图片关联</el-col>
            <el-col :span="24">
              <el-radio-group @change="radioBtn" v-model="radio">
                <el-radio
                  v-for="(item, index) in tite"
                  :key="index"
                  :label="tite[index]"
      ...
      <el-col :span="6">
        <el-form-item label="刊登分类2">
          <el-input size="small" style="width:245px;" v-model="wishForm.listedSubcate"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="6">
        <el-form-item label="标题">
          <el-input size="small" style="width:245px;" v-model="wishForm.title"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="6">
        <el-form-item label="子标题">
          <el-input size="small" style="width:245px;" v-model="wishForm.subTitle"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="24">
        <el-col :span="24">
      ...
      <el-col :span="24" style="margin-top: 20px">
        <el-col :span="8">
          <el-col :span="4" style="text-align: right;margin-top: 13px;padding-right: 10px">数量</el-col>
          <el-col :span="20">
            <el-input style="width:100%;" v-model="wishForm.quantity"></el-input>
          </el-col>
        </el-col>
        <el-col :span="8">
          <el-col :span="4" style="text-align: right;margin-top: 13px;padding-right: 10px">UPC</el-col>
          <el-col :span="20">
            <el-input style="width:100%;" v-model="wishForm.UPC"></el-input>
          </el-col>
        </el-col>
        <el-col :span="8">
          <el-col :span="4" style="text-align: right;margin-top: 13px;padding-right: 10px">EAN</el-col>
          <el-col :span="19">
            <el-input style="width:100%;" v-model="wishForm.EAN"></el-input>
          </el-col>
        </el-col>
      ...
      <!--</el-table>-->
      <el-col :span="24">
        <el-col :span="7" style="margin-left: 20px">属性名称</el-col>
        <el-col :span="7" style="margin-left: 15px">属性内容</el-col>
        <el-col :span="24" style="margin-top: 8px" v-for="(item,index) in tableData" :key="index">
          <el-col :span="24" style="margin-top: 10px" v-for="(log,key) in item" :key="key">
      ...
      <el-col :span="24" style="margin-top: 18px;margin-bottom: 5px">
        <el-button type="primary" @click="dialogFormVisible = true" style="margin-left: 20px">增加属性</el-button>
      </el-col>
      <el-col :span="24" style="padding: 0">
      ...
      <el-dialog title="多属性设置" :visible.sync="outerVisible" style="padding: 0" width="90%">
        <el-row>
          <el-col :span="24">
            <el-col :span="18">多属性设置</el-col>
            <el-col :span="6" style="text-align: right">
              <!-- 第1-12条共12条数据 -->
              <el-button @click="innerVisible = true" type="text">+增加属性</el-button>
            </el-col>
          </el-col>
        </el-row>
        <el-row>
                ...
                <tr>
                  ...
                  >
                    ...
                    <i
                      class="el-icon-delete"
                      @click="titleDel(index)"
                      style="position: absolute;right: 45px;top: 22px;z-index: 999;cursor: pointer"
                    ></i>
                  </th>
                </tr>
              </thead>
        ...
        <el-row style="margin-top: 20px">
          ...
          <el-col :span="24" style="margin-top: 20px;margin-bottom: 25px">图片关联</el-col>
          <el-col :span="24">
            <el-radio-group @change="radioBtn" v-model="radio">
              <el-radio
                v-for="(item, index) in tite"
      ...
      <el-dialog width="30%" title="添加属性" :visible.sync="innerVisible" append-to-body>
        <el-input v-model="columns" placeholder="属性名称"></el-input>
        <div slot="footer" class="dialog-footer">
          <el-button @click="innerVisible = false" type="primary">取 消</el-button>
          <el-button @click="addColumn" type="primary">确 定</el-button>
        </div>
      </el-dialog>
      <el-dialog title="增加属性" :visible.sync="dialogFormVisible">
        <el-input placeholder="属性名称" v-model="qualityId"></el-input>
        <el-input placeholder="属性内容" style="margin-top: 15px" v-model="qualityContent"></el-input>
        <div slot="footer" class="dialog-footer">
    ...
    getData() {
      APIPlatInfo(this.condition).then(res => {
        ...
        this.tableData = JSON.parse(
          res.data.data.basicInfo.specifics
        ).specifics;
