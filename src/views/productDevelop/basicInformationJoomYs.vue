  ...
  <section>
    <div>
      <el-row class="contentt">
        <el-col :span="24">
          <el-button type="primary" @click="addJoomEbayYs()">
            <i class="el-icon-plus"></i>添加运输方式
          </el-button>
        </el-col>
      </el-row>
      <el-row class="content1">
        <el-col :span="24" class="font14">第1-20条，共{{totalEbayYs}}条数据.</el-col>
        <el-col :span="24" style="margin-top: 20px">
          ...
          >
            ...
            <el-table-column label="操作" fixed header-align="center" width="80">
              <template slot-scope="scope">
                ...
                <el-tooltip content="更新">
                  <i
                    @click="editEbayYs(scope.$index, scope.row)"
                    class="el-icon-edit"
                    style="color: #409EFF;cursor:pointer;"
                  ></i>
                </el-tooltip>
                <el-tooltip content="删除">
                  <i
                    ...
                    style="color: #409EFF;cursor:pointer;"
                    @click="delEbayYs(scope.$index, scope.row)"
                  ></i>
                </el-tooltip>
              </template>
            </el-table-column>
            <el-table-column label="运输方式" header-align="center">
              <el-table-column
                prop="servicesName"
            ...
            <el-table-column label="国家名称" header-align="center">
              <el-table-column
                prop="site"
                :render-header="renderHeaderPicEbayYs"
                align="center"
            ...
            <el-table-column label="Ibay识别运输方式" header-align="center">
              <el-table-column
                prop="ibayShipping"
                :render-header="renderHeaderPicEbayYs"
                align="center"
          ...
          <el-col :span="24" class="cTop">
            ...
            <el-col :span="24" style="margin-bottom: 20px">
              ...
              <el-col :span="20">
                ...
                <el-select v-model="countryYs" style="width:100%">
                  <el-option
          ...
          <el-col :span="24" class="cTop">
            ...
            <el-col :span="24" style="margin-bottom: 20px">
              ...
              <el-col :span="20">
                ...
                <el-select v-model="contenEbayYs.site" style="width:100%">
                  <el-option
                    v-for="(item, key) in ebaySite"
                    :key="item.key"
                    :label="item.name"
...
import { getEbaySite } from "../../api/profit";
  ...
  methods: {
    addJoomTjEbayYs() {
      ...
      for(let i=0;i<this.ebaySite.length;i++){
          if(this.countryYs==this.ebaySite[i].name){
              str=this.ebaySite[i].code
          }
      }  
      var condate = {
    ...
    saveEbayYs() {
       for(let i=0;i<this.ebaySite.length;i++){
          if(this.contenEbayYs.site==this.ebaySite[i].name){
              this.contenEbayYs.site=this.ebaySite[i].code
        }
      }
