<template>
  <section class="toolbar">
    ...
    <div v-show="show.forward">
      <el-col :span="24" style="padding:10px 15px;">
        <el-button type="success" @click="showZx" class="mr5">新增产品</el-button>
        <el-button type="warning" class="mr5">批量导入</el-button>
        <el-button type="danger" @click="delAll1" class="mr5">批量删除</el-button>
        <el-button type="primary" class="mr5">下载模板</el-button>
      ...
      <el-dialog title="新增" :visible.sync="dialogVisible1" width="58%">
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="图片" prop="img">
              <el-input size="small" v-model="addForm1.img" placeholder="必填" style="width:95%"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="主类目" prop="cate">
              <el-select
                size="small"
                v-model="addForm1.cate"
                @change="productcategory1"
                style="width:95%;"
                placeholder="请选择父类"
              >
                <el-option v-for="item in cate" :value="item" :key="item"></el-option>
          ...
          <el-col :span="8">
            ...
            >
              <el-input size="small" v-model="addForm1.vendor1" placeholder="必填" style="width:95%;"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="供应商链接2" prop="vendor2">
              <el-input size="small" v-model="addForm1.vendor2" style="width:95%"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="供应商链接3" prop="vendor3">
              <el-input size="small" v-model="addForm1.vendor3" style="width:95%"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="平台参考链接1" prop="origin1">
              <el-input size="small" v-model="addForm1.origin1" placeholder="选填" style="width:95%"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="平台参考链接2" prop="origin2">
              <el-input size="small" v-model="addForm1.origin2" placeholder="选填" style="width:95%"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="平台参考链接3" prop="origin3">
              <el-input size="small" v-model="addForm1.origin3" placeholder="选填" style="width:95%"></el-input>
            </el-form-item>         
          </el-col>
          <el-col :span="8">
            <!-- <el-form-item label="开发员" prop='developer'>
            ...
            <el-form-item label="售价($)" prop="salePrice">
              <el-input size="small" v-model="addForm1.salePrice" placeholder="选填" style="width:95%"></el-input>
            </el-form-item>            
          </el-col>
          <el-col :span="8">
            <el-form-item label="预估月销量" prop="hopeSale">
              <el-input size="small" v-model="addForm1.hopeSale" placeholder="选填" style="width:95%"></el-input>
            </el-form-item>            
          </el-col>
          <el-col :span="8">
            <el-form-item label="预估利润率(%)" prop="hopeRate">
              <el-input size="small" v-model="addForm1.hopeRate" placeholder="选填" style="width:95%"></el-input>
            </el-form-item>            
          </el-col>
          <el-col :span="8">
            <el-form-item label="预估重量(克)" prop="hopeWeight">
              <el-input size="small" v-model="addForm1.hopeWeight" placeholder="选填" style="width:95%"></el-input>
            </el-form-item>            
          </el-col>
          <el-col :span="8">
            <el-form-item label="预估成本(￥)" prop="hopeCost">
              <el-input size="small" v-model="addForm1.hopeCost" placeholder="选填" style="width:95%"></el-input>
            </el-form-item>            
          </el-col>
          <el-col :span="8">
            <el-form-item label="预估月毛利($)" prop="hopeMonthProfit">
              <el-input size="small" v-model="addForm1.hopeMonthProfit" disabled placeholder="自动计算" style="width:95%;"></el-input>
            </el-form-item>            
          </el-col>
          <el-col :span="8">
            <el-form-item label>
    ...
    <div v-show="show.reverse">
      <el-col :span="24" style="padding:10px 15px;">
        <el-button type="success" @click="showNx" class="mr5">新增产品</el-button>
        <el-button type="warning" class="mr5">批量导入</el-button>
        <el-button type="danger" @click="delAll2" class="mr5">批量删除</el-button>
        <el-button type="primary" class="mr5">下载模板</el-button>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        cate: [{ required: true, message: "主类目不能为空", trigger: "blur" }],
        subCate: [
    ...
    submitEdit1() {
      this.$refs.editForm.validate(valid => {
        if (valid) {
          ...
          if (
            this.editForm.stockUp !== "是" &&
            this.editForm.stockUp !== "否"
          ) {
            this.editForm.stockUp
              ? (this.editForm.stockUp = "是")
              : (this.editForm.stockUp = "否");
          }
