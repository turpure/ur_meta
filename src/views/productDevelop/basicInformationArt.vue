    ...
    <section>
        <div>
            <el-row class="contentt">
                <el-col :span="24">
                    <el-button type="primary" @click="addJoomArt()"><i class="el-icon-plus"></i>创建</el-button>
                </el-col>
            </el-row>
            <el-row class="content1">
                <el-col :span="24" class="font14">
                    第1-20条，共{{totalArt}}条数据.
                </el-col>
                    ...
                    <el-table :data="dateArt"
                        ...
                        <el-table-column label="操作"
                            ...
                            <template slot-scope="scope">
                                ...
                                <el-tooltip content="更新">
                                    <i @click="editArt(scope.$index, scope.row)"
                                       class="el-icon-edit"
                                       style="color: #409EFF;cursor:pointer;"></i>
                                </el-tooltip>
                                <el-tooltip content="删除">
                                    <i class="el-icon-delete"
                                       style="color: #409EFF;cursor:pointer;" @click="delArt(scope.$index, scope.row)"></i>
                                </el-tooltip>
                            </template>
                        </el-table-column>
                        <el-table-column label="规则名称"
                            ...
                            <el-table-column prop="ruleName"
                                             :render-header="renderHeaderPicArt"
                                             align="center">
                            </el-table-column>
                        </el-table-column>
                        <el-table-column label="开发员"
                                         header-align="center">
                            <el-table-column prop="ruleKey"
                                             :render-header="renderHeaderPicArt"
                                             align="center"
                            >
                            </el-table-column>
                        </el-table-column>
                        <el-table-column label="对应美工或采购"
                                         header-align="center">
                            <el-table-column prop="ruleValue"
                                             :render-header="renderHeaderPicArt"
                                             align="center">
                            </el-table-column>
                        </el-table-column>
...
<script type="text/ecmascript-6">
    import { APIWishSuffix,
            ...
            APIRulesInfo,
            APIUpdateRules,
            APIDeleteRules} from '../../api/product'
