<template>
  <section>
    <el-tabs v-model="activeName" type="card" @tab-click="handleClick" class="toolbar">
      <el-tab-pane
    ...
    <div v-show="show.wish">
      ...
      <el-row class="content1">
        <el-col :span="24" class="font14">第1-20条，共{{totalWish}}条数据.</el-col>
        <el-col :span="23" style="margin-top: 20px">
          <el-table :data="date" border class="elTable" :height="tableHeight" style="width: 100%">
            ...
            <el-table-column label="操作" fixed header-align="center" width="80">
              <template slot-scope="scope">
                ...
                <el-tooltip content="更新">
                  <i
                    @click="editWish(scope.$index, scope.row)"
                    class="el-icon-edit"
                    style="color: #409EFF;cursor:pointer;"
                  ></i>
                </el-tooltip>
                <el-tooltip content="删除">
                  <i
                    ...
                    style="color: #409EFF;cursor:pointer;"
                    @click="delWish(scope.$index, scope.row)"
                  ></i>
                </el-tooltip>
              </template>
            </el-table-column>
            <el-table-column label="卖家账号" header-align="center">
              <el-table-column prop="ibaySuffix" :render-header="renderHeaderPic" align="center"></el-table-column>
            </el-table-column>
            <el-table-column label="简称" header-align="center">
              <el-table-column prop="shortName" :render-header="renderHeaderPic" align="center"></el-table-column>
            </el-table-column>
            <el-table-column label="本地货币" header-align="center">
              <el-table-column prop="localCurrency" :render-header="renderHeaderPic" align="center"></el-table-column>
            </el-table-column>
            <el-table-column label="后缀" header-align="center">
              <el-table-column prop="suffix" :render-header="renderHeaderPic" align="center"></el-table-column>
            </el-table-column>
            <el-table-column label="运费比例" header-align="center">
              <el-table-column prop="rate" :render-header="renderHeaderPic" align="center"></el-table-column>
            </el-table-column>
            <el-table-column label="主图名称" header-align="center">
              <el-table-column prop="mainImg" :render-header="renderHeaderPic" align="center"></el-table-column>
            </el-table-column>
          </el-table>
        </el-col>
      </el-row>
            ...
            <tbody>
              <tr>
                ...
                <td
                  width="20%"
                  style="text-align: center;font-weight: normal;line-height: 45px;border: #d4d4d4 solid 1px"
                >{{delistWish.ibaySuffix}}</td>
                <td
                  width="20%"
                  style="text-align: center;font-weight: normal;line-height: 45px;border: #d4d4d4 solid 1px"
                >{{delistWish.suffix}}</td>
                <td
                  width="20%"
                  style="text-align: center;font-weight: normal;line-height: 45px;border: #d4d4d4 solid 1px"
                >{{delistWish.rate}}</td>
      ...
      <el-dialog title="编辑Wish字典" :visible.sync="dialogPictureBj">
        <el-row class="contentt" style="margin-top: 0">
          <el-col
            :span="24"
            style="margin-bottom: 20px;font-size: 16px;color: #66b1ff"
          >Update Wish Suffix Dictionary: {{contenWish.id}}</el-col>
          <el-col :span="24" class="cTop">
            ...
            <el-col :span="24" style="margin-bottom: 20px">
              ...
              <el-col :span="21">
                <el-select v-model="contenWish.localCurrency" placeholder="请选择" style="width:100%">
                  <el-option
        ...
        <el-row class="contentt" style="margin-top: 0">
          <el-col :span="24" class="cTop">
            ...
            <el-col :span="24" style="margin-bottom: 20px">
              ...
              <el-col :span="20">
                <el-select v-model="localCurrency" placeholder="请选择" style="width:100%">
                  <el-option
                    v-for="item in options"
                    :key="item"
                    :label="item"
