<template>
  <section>
    <div v-show="show.management">
      ...
      >
        <el-table-column type="selection" fixed align="center" header-align="center" width="65"></el-table-column>
        <el-table-column label="动作" fixed header-align="center" width="85">
          <template slot-scope="scope">
            <el-dropdown :hide-on-click="false">
              <span class="el-dropdown-link" style="font-size: 14px;margin-left: 10px">
                操作
                <i class="el-icon-arrow-down el-icon--right"></i>
              </span>
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item>
                  <span @click="mx(scope.$index, scope.row)">订单明细</span>
                </el-dropdown-item>
                <!--<el-dropdown-item>编辑订单</el-dropdown-item>-->
                <el-dropdown-item>
                  <span @click="synchro(scope.$index, scope.row)">同步普源数据</span>
                </el-dropdown-item>
                <el-dropdown-item>
                  <span @click="pay(scope.$index, scope.row)">请求付款</span>
                </el-dropdown-item>
                <el-dropdown-item>
                  <span @click="payMx(scope.$index, scope.row)">付款明细</span>
                </el-dropdown-item>
                <el-dropdown-item>
                  <span @click="delivery(scope.$index, scope.row)">发货</span>
                </el-dropdown-item>
                <el-dropdown-item>
                  <span @click="importWl(scope.$index, scope.row)">导入物流单号</span>
                </el-dropdown-item>
                <el-dropdown-item>导入发货单</el-dropdown-item>
                <el-dropdown-item>
                  <span @click="toExamine(scope.$index, scope.row)">审核单据</span>
                </el-dropdown-item>
                <el-dropdown-item>
                  <span @click="importMx(scope.$index, scope.row)">导出采购单明细</span>
                </el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
          </template>
        </el-table-column>
        <el-table-column label="采购单号" header-align="center">
        ...
        <el-table-column label="供应商名称" header-align="center">
          <el-table-column prop="supplierName" :render-header="renderHeader" align="center"></el-table-column>
        </el-table-column>
        <el-table-column label="采购单状态" header-align="center">
          <el-table-column prop="billStatus" :render-header="renderHeader" align="center"></el-table-column>
        </el-table-column>
        <el-table-column label="线下采购" header-align="center">
          <el-table-column prop="purchaser" :render-header="renderHeader" align="center"></el-table-column>
        </el-table-column>
        <el-table-column label="同步时间" header-align="center">
          <el-table-column prop="syncTime" :render-header="renderHeader" align="center"></el-table-column>
        </el-table-column>
        <el-table-column label="总数量" header-align="center">
          <el-table-column prop="totalNumber" :render-header="renderHeader" align="center"></el-table-column>
        </el-table-column>
        <el-table-column label="总金额(￥)" header-align="center">
          <el-table-column prop="amt" :render-header="renderHeader" align="center"></el-table-column>
        </el-table-column>
        <el-table-column label="支付金额(￥)" header-align="center">
          <el-table-column prop="paymentAmt" :render-header="renderHeader" align="center"></el-table-column>
        </el-table-column>
        <el-table-column label="未支付金额(￥)" header-align="center">
          <el-table-column prop="unpaidAmt" :render-header="renderHeader" align="center"></el-table-column>
        </el-table-column>
        <el-table-column label="发货状态" header-align="center">
          <el-table-column prop="deliveryStatus" :render-header="renderHeader" align="center"></el-table-column>
        </el-table-column>
        <el-table-column label="物流单号" header-align="center">
          <el-table-column prop="expressNumber" :render-header="renderHeader" align="center"></el-table-column>
        </el-table-column>
        <el-table-column label="支付状态" header-align="center">
          <el-table-column prop="paymentStatus" :render-header="renderHeader" align="center"></el-table-column>
        </el-table-column>
      </el-table>
      <el-pagination
        class="toolbar"
