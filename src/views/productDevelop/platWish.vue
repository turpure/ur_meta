  ...
  <section>
    ...
    >
      ...
      <el-col :span="24" style="margin-top: 15px">
        ...
        <el-col :span="22">
          <el-input v-model="wishForm.inventory" style="width:100%;margin-left: 27px"></el-input>
        </el-col>
      </el-col>
      <el-col :span="24" style="margin-top: 15px">
        <span
          style="text-align: right;margin-top: 8px;float: left;padding-left: 35px;margin-right: 7px"
        >运输时间</span>
        <el-col :span="22">
