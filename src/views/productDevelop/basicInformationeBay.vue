    ...
    <section>
        <div>
            <el-row class="contentt">
                <el-col :span="24">
                    <el-button type="primary" @click="addJoomEbay()"><i class="el-icon-plus"></i>添加eBay账号</el-button>
                </el-col>
            </el-row>
            <el-row class="content1">
                <el-col :span="24" class="font14">
                    第1-20条，共{{totalEbay}}条数据.
                </el-col>
                <el-col :span="24" style="margin-top: 20px">
                    <el-table :data="dateEbay"
                              border
                              class="elTable"
                              style="width: 98%;">
                        ...
                        <el-table-column label="操作"
                            ...
                            <template slot-scope="scope">
                                ...
                                <el-tooltip content="更新">
                                    <i @click="editEbay(scope.$index, scope.row)"
                                       class="el-icon-edit"
                                       style="color: #409EFF;cursor:pointer;"></i>
                                </el-tooltip>
                                <el-tooltip content="删除">
                                    <i class="el-icon-delete"
                                       style="color: #409EFF;cursor:pointer;" @click="delEbay(scope.$index, scope.row)"></i>
                                </el-tooltip>
                            </template>
                        </el-table-column>
                        <el-table-column label="eBay账号"
                                         header-align="center">
                            <el-table-column prop="ebayName"
                                             :render-header="renderHeaderPicEbay"
                                             align="center">
                            </el-table-column>
                        </el-table-column>
                        <el-table-column label="eBay账号简称"
                                         header-align="center">
                            <el-table-column prop="ebaySuffix"
                                             :render-header="renderHeaderPicEbay"
                                             align="center">
                            </el-table-column>
                        </el-table-column>
                        <el-table-column label="仓储国家"
                                         header-align="center">
                            <el-table-column prop="storeCountry"
                                             :render-header="renderHeaderPicEbay"
                                             align="center"
                                             width="160">
                            </el-table-column>
                        </el-table-column>
                        <el-table-column label="eBay编码"
                                         header-align="center">
                        ...
                        <el-table-column label="刊登风格"
                                         header-align="center">
                            <el-table-column prop="ibayTemplate"
                                             :render-header="renderHeaderPicEbay"
                                             align="center"
                                             width="150">
                            </el-table-column>
                        </el-table-column>
                        <el-table-column label="大额PayPal"
                                         header-align="center">
                        ...
                        <el-table-column label="小额PayPal"
                                         header-align="center">
...
<script type="text/ecmascript-6">
    import { APIWishSuffix,
            ...
            ,APIEbayInfo,
            APIDeleteEbay,
            APIUpdateEbay } from '../../api/product'
