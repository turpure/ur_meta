<template>
  <section class="toolbar">
    <el-row>
    <el-form :inline="true" :model='condition' label-width="90px">
      <el-form-item prop="sku" label="SKU*">
        <el-input size="small" v-model="condition.sku" placeholder="请填写产品SKU" style="width:150px"></el-input>
      </el-form-item>
      <el-form-item prop="num" label="SKU套装">
        <el-input size="small" v-model="condition.num" placeholder="请填写套装数量" style="width:150px"></el-input>
      </el-form-item>
      <el-form-item prop="price" label="售价(AU $)">
        <el-input size="small" v-model="condition.price" placeholder="请填写预计售价" style="width:150px"></el-input>
      </el-form-item>
      <el-form-item prop="rate" label="毛利率">
        <el-input size="small" v-model="condition.rate" placeholder="请填写预计毛利率(%)" style="width:160px"></el-input>
      </el-form-item>
      <el-form-item>
    ...
    <h4>SKU信息</h4>
        ...
        <el-table :data="tableData4" style="width:100%">
          ...
          <el-table-column prop="outRmb" label="出库费（AU ￥）"></el-table-column>
