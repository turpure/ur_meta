<template>
  ...
  <div class="toolbar">
    ...
    >
      ...
      <el-table-column prop="hopeUseNum" label="义乌仓库存" sortable="custom" width="110" align="center"></el-table-column>
      <el-table-column prop="amount" label="义乌仓采购未审核" sortable="custom" width="150" align="center"></el-table-column>
      <el-table-column prop="totalHopeUN" label="预计可用库存" sortable="custom" width="125" align="center"></el-table-column>
      ...
      <el-table-column prop="price" label="单价" sortable="custom" width="100" align="center"></el-table-column>
    </el-table>
