<template>
  <section>
    ...
    <div v-show="risk">
      <el-form :model="condition" :inline="true" class="toolbar" label-width="60px">
      ...
      >
        <el-table-column label="订单编号" prop="tradeNid" align="center" width="100"></el-table-column>
        ...
        <el-table-column label="收货地址" prop="shipToStreet" align="center" width="140"></el-table-column>
        <el-table-column label="收货地址2" prop="shipToStreet2" align="center" width="140"></el-table-column>
        <el-table-column label="城市" prop="shipToCity" align="center" width="100"></el-table-column>
        <el-table-column label="邮编" prop="shipToZip" align="center" width="100"></el-table-column>
        <el-table-column label="国家" prop="shipToCountryCode" align="center" width="100"></el-table-column>
        <el-table-column label="电话" prop="shipToPhoneNum" align="center" width="100"></el-table-column>
        <el-table-column label="处理人" prop="processor" align="center" width="100"></el-table-column>
        <el-table-column label="处理状态" prop="completeStatus" align="center" width="100">
          <template slot-scope="scope">
        ...
        <el-table-column label="操作" align="center" width="155">
          <template slot-scope="scope">
            <el-button
              :type="tags[scope.row.completeStatus]['type']"
              round
              size="small"
    ...
    <div v-show="blacklist" class="toolbar" style="padding:10px 20px;">
      ...
      >
        ...
        <tbody>
          <tr v-for="(item, index) in blackData" :key="index" style="text-align:center;">
            ...
            <td>
              <el-button size="mini" type="danger" @click="del(item.id)" style="margin:-20px;">删除</el-button>
            </td>
          </tr>
        </tbody>
      </table>
