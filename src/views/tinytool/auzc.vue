<template>
  ...
  <div class="toolbar">
    ...
    >
      ...
      <el-table-column prop="uHopeUseNum" label="万邑通UK预计可用库存" sortable="custom" width="185" align="center"></el-table-column>
      <el-table-column prop="totalHopeUseNum" label="预计可用库存" sortable="custom" width="140" align="center"></el-table-column>
      <el-table-column prop="uHopeSaleDays" label="万邑通UK预计可用天数" sortable="custom" width="185" align="center"></el-table-column>
