      ...
      <div class="left-boxCase">
        ...
        <div class="leftBox">
          <div class="bigDemo" ref="bigDemo">
            ...
            <div class="rightDemo">
              <div
               v-for="(item,index) in last120"
                :key="index"
                @click="judge(item.rate)"
                :class="[item.rxtraBonus==1600?'indexbImg jb016img':item.rxtraBonus==1700?'indexbImg1 jb017img':item.rxtraBonus==1800?'indexbImg1 jb018img':item.rxtraBonus==1900?'indexbImg1 jb019img':item.rxtraBonus==2000?'indexbImg1 jb020img':item.rxtraBonus==2100?'indexbImg1 jb021img':item.rxtraBonus==2200?'indexbImg1 jb022img':item.rxtraBonus==2300?'indexbImg1 jb023img':item.rxtraBonus==2400?'indexbImg1 jb024img':item.rxtraBonus==2500?'indexbImg1 jb025img':item.rxtraBonus==2600?'indexbImg1 jb026img':'',item.username==sysUserName?'imbge':'']"
              >
              </div>
              <div class="jblist">
                <div class="jbg jbr1">
            ...
            <div class="rightDemo">
              <div
               v-for="(item,index) in last160"
                :key="index"
                @click="judge(item.rate)"
                :class="[item.rxtraBonus==6000?'indexbImg jb016img':item.rxtraBonus==6100?'indexbImg1 jb017img':item.rxtraBonus==6200?'indexbImg1 jb018img':item.rxtraBonus==6300?'indexbImg1 jb019img':item.rxtraBonus==6400?'indexbImg1 jb020img':item.rxtraBonus==6500?'indexbImg1 jb021img':item.rxtraBonus==6600?'indexbImg1 jb022img':item.rxtraBonus==6700?'indexbImg1 jb023img':item.rxtraBonus==6800?'indexbImg1 jb024img':item.rxtraBonus==6900?'indexbImg1 jb025img':item.rxtraBonus==7000?'indexbImg1 jb026img':'',item.username==sysUserName?'imbge':'']"
              >
              </div>
              <div class="jblist">
                <div class="jbg jbr1">
            ...
            <div class="leftDemo">
              <div
               v-for="(item,index) in last170"
                :key="index"
                @click="judge(item.rate)"
                :class="[item.rxtraBonus==7100?'indexbImg1 jb027img':item.rxtraBonus==7200?'indexbImg jb028img':item.rxtraBonus==7300?'indexbImg jb029img':item.rxtraBonus==7400?'indexbImg jb030img':item.rxtraBonus==7500?'indexbImg jb031img':item.rxtraBonus==7600?'indexbImg jb032img':item.rxtraBonus==7700?'indexbImg jb033img':item.rxtraBonus==7800?'indexbImg jb034img':item.rxtraBonus==7900?'indexbImg jb035img':item.rxtraBonus==8000?'indexbImg jb036img':item.rxtraBonus==8100?'indexbImg jb037img':'',item.username==sysUserName?'imbge':'']"
              >
              </div>
              <div class="jblist">
                <div class="jb05 jbg">
            ...
            <div class="rightDemo">
              <div
               v-for="(item,index) in last200"
                :key="index"
                @click="judge(item.rate)"
                :class="[item.rxtraBonus==10400?'indexbImg jb016img':item.rxtraBonus==10500?'indexbImg1 jb017img':item.rxtraBonus==10600?'indexbImg1 jb018img':item.rxtraBonus==10700?'indexbImg1 jb019img':item.rxtraBonus==10800?'indexbImg1 jb020img':item.rxtraBonus==10900?'indexbImg1 jb021img':item.rxtraBonus==11000?'indexbImg1 jb022img':item.rxtraBonus==11100?'indexbImg1 jb023img':item.rxtraBonus==11200?'indexbImg1 jb024img':item.rxtraBonus==11300?'indexbImg1 jb025img':item.rxtraBonus==11400?'indexbImg1 jb026img':'',item.username==sysUserName?'imbge':'']"
              >
              </div>
              <div class="jblist">
                <div class="jbg jbr1">
            ...
            <div class="leftDemo">
              <div
               v-for="(item,index) in last210"
                :key="index"
                @click="judge(item.rate)"
                :class="[item.rxtraBonus==11500?'indexbImg1 jb027img':item.rxtraBonus==11600?'indexbImg jb028img':item.rxtraBonus==11700?'indexbImg jb029img':item.rxtraBonus==11800?'indexbImg jb030img':item.rxtraBonus==11900?'indexbImg jb031img':item.rxtraBonus==12000?'indexbImg jb032img':item.rxtraBonus==12100?'indexbImg jb033img':item.rxtraBonus==12200?'indexbImg jb034img':item.rxtraBonus==12300?'indexbImg jb035img':item.rxtraBonus==12400?'indexbImg jb036img':item.rxtraBonus==12500?'indexbImg jb037img':'',item.username==sysUserName?'imbge':'']"
              >
              </div>
              <div class="jblist">
                <div class="jb05 jbg">
            ...
            <div class="cardRight">
              ...
              <div class="cardText">
                <div class="cardText01" v-for="(item,index) in bonusList" :key="index">
                  ...
                  <p v-if= "item.vacationDays && item.vacationDays.length > 0" class="njts">{{item.vacationDays}}天</p>
                  <p v-else  class="njts">0天</p>
  ...
  mounted() {
    ...
    APISiteIndex().then(res => {
      ...
      for (var i = 0; i < arrData.length; i++) {
        ...
        if (arrData[i].rate >= 100 && arrData[i].rxtraBonus >1500 &&  arrData[i].rxtraBonus >0<=2600) {
          this.last120.push(arrData[i]);
        }
        ...
        if (arrData[i].rate >= 100 && arrData[i].rxtraBonus >5900 &&  arrData[i].rxtraBonus >0<=7000) {
          this.last160.push(arrData[i]);
        }
        ...
        if (arrData[i].rate >= 100 && arrData[i].rxtraBonus >10300 &&  arrData[i].rxtraBonus >0<=11400) {
          this.last200.push(arrData[i]);
        }
        if (arrData[i].rate >= 100 && arrData[i].rxtraBonus >11400 &&  arrData[i].rxtraBonus >0<=12500) {
          this.last210.push(arrData[i]);
        }
      }
