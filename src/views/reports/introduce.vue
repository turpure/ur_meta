<template>
  ...
  <div>
    ...
    <el-table ref="table" :data="tableData" id="sale-table" size="medium" v-loading="listLoading" @sort-change="sortNumber" show-summary :summary-method="getSummaries" v-show="show2" :height="tableHeight" :max-height="tableHeight" :highlight-current-row="true" style="width: 100%;zoom:0.9;">
      <el-table-column min-width="100px" prop="salernameZero" label="推荐人" :formatter="empty" sortable></el-table-column>
      ...
      <el-table-column min-width="160px" prop="netratetotal" label="毛利率%（汇总）" :formatter="empty" sortable="custom"></el-table-column>
    </el-table>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    exportExcel() {
      ...
      let Filename =
        "推荐人毛利润报表" + year + month + strDate + hour + minute + second;
