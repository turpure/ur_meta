...
import { getUserName,getLeftSide } from '../api/name'
import { getMyToken } from '../api/api'
	...
	export default {
		...
		mounted() {
			...
			getUserName(access_token).then(response=>{
				const data = response.data
				this.sysUserName = data.data.username
			}),
			getLeftSide(access_token).then(response=>{
